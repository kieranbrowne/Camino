...
main = do 
    ...
    output $ flowPaths $ replicate 4 (take 4 $ addPaths (rect 0 0 100 100) $ intersperse (0,0) (10,10) 4) 
    output $ flowPaths $ replicate 4 (take 80 $ (addPaths (circle 12 12 4) $ intersperse (0,0) (60,70) 89))  
